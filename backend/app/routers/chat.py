...
from app.chat.chat import manager, create_new_conversation, get_user_conversations, get_conversation_with_messages, create_message, get_user_notifications, mark_notification_read, mark_all_notifications_read, get_user_chat_stats, create_notification, send_message_websocket, send_notification, send_message, send_read_receipt, send_read_receipt
...
async def send_message(
    ...
    await send_message_websocket(recipient_id, {
        "id": message.id,
        "conversation_id": conversation.id,
